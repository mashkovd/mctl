...
module "kube-hetzner" {
  ...
  # * Your ssh public key
  ssh_public_key  = var.ssh_public_key != "" ? var.ssh_public_key : try(file("~/.ssh/id_ed25519.pub"), null)
  ...
  ssh_private_key = var.ssh_private_key != "" ? var.ssh_private_key : try(file("~/.ssh/id_ed25519"), null)
